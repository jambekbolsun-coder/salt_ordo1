...
import { BarChart3, CheckCircle2, Eye, HelpCircle, MessageCircle, MousePointerClick, UsersRound, XCircle } from 'lucide-react'
...
export default function Analytics() {
  ...
  const report = useMemo(() => {
    ...
    const events = data.events.filter((row)=>new Date(row.created_at).getTime() >= since)
